// ─────────────────────────────────────────────────────────────────────────
// FROZEN ORACLE — do not edit by hand.
//
// Verbatim snapshot of src/game/nnue/encode.ts's encoder as shipped at
// commit a13500f, before the encodeSparse refactor. It exists ONLY so the
// parity gate (scripts/nnue-accum-parity.ts, `npm run nnue:parity`) can
// assert that encodeState() is still byte-identical to the pre-refactor
// layout. If a deliberate, intentional feature-layout change is ever
// made to encode.ts, the gate will fail loudly here — that is the point;
// re-snapshot this file only as a conscious model-breaking decision.
// ─────────────────────────────────────────────────────────────────────────
